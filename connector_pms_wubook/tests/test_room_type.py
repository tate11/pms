...
# @tagged('test_debug')
# class TestKK(common.TestWubookConnector):
#     def test_kk(self):
...
#             {
#                 "name": "Test backend",
#                 "pms_property_id": self.ref("pms.main_pms_property"),
#                 "model_id": self.ref(
...
# @tagged("test_debug")
# class TestWubookServerMock(common.TestWubookConnector):
...
class TestWubookConnectorRoomTypeExport(common.TestWubookConnector):
    @mock.patch.object(xmlrpc.client, "Server")
    def aaatest_export_existing_case01(self, mock_xmlrpc_client_server):
        """
        PRE:    - r1 exists
                - r1 has code 'c1'
                - r1 has property p1
