...
class DataBi(models.Model):
    ...
    #     dic_pais.append({'data_bi_id': property_id,
    #                      'ID_Pais': 'NONE',
    ...
    #     for room in rooms:
    #         dic_rooms.append({'data_bi_id': property_id,
    #                           'ID_Room': room['id'],
    ...
    #                                                     len(board_services)))
    #     dic_regimen.append({'data_bi_id': property_id,
    #                         'ID_Regimen': 0,
    ...
    #         dic_estados.append({'data_bi_id': property_id,
    #                             'ID_EstadoReserva': i,
    ...
    #         dic_budget.append({'data_bi_id': property_id,
    ...
    #         dic_moti_bloq.append({'data_bi_id': property_id,
    #                               'ID_Motivo_Bloqueo': i,
    ...
    #             dic_segmentos.append({'data_bi_id': property_id,
    ...
    #     dic_clientes.append({'data_bi_id': property_id,
    #                          'ID_Cliente': 0,
    ...
    #     # data_bi_id numérico Código del Hotel
